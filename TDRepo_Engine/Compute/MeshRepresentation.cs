...
namespace BH.Engine.External.TDRepo
{
    public static partial class Compute
    {
        ...
        public static BH.oM.Geometry.Mesh MeshRepresentation(IObject obj, DisplayOptions displayOptions = null)
        {
            ...
            dynamic bhomRepresentation = Compute.BHoMRepresentation(obj as dynamic, displayOptions);

            BH.oM.Geometry.Mesh meshRepresentation = bhomRepresentation as BH.oM.Geometry.Mesh;
