...
namespace BH.Engine.External.TDRepo
{
    public static partial class Compute
    {
        ...
        public static BH.oM.Geometry.Mesh MeshRepresentation(this BoundingBox bbox, DisplayOptions displayOptions = null)
        {
            displayOptions = displayOptions ?? new DisplayOptions();

            return bbox.RhinoMeshRepresentation(displayOptions).FromRhino();
        }
